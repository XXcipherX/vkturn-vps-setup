...
Файл **.env** содержит секреты и создаётся с правами 600. Каталог резервных копий имеет права 700, файлы внутри — 600. Docker stdout-логи ограничены тремя файлами по 10 МБ, чтобы длительная работа сервера не заполняла диск.
